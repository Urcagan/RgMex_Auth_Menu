<template>
    <aside :class="`${is_expanded && 'is-expanded'}`">
        <div class="logo">
            <img src="/public/assets/vue.svg" alt="Logo">
        </div>
        ...
        <div class="menu">
            ...
            <router-link class="button" :to="{name: 'user.personal'}">
...
<!--            </router-link>-->
            ...
            <router-link class="button" :to="{name: 'get.index'}">
<!--                <span class="material-icons">email</span>-->
                <span class="material-icons">group_work</span>
                <span class="text">Get Protected</span>
            </router-link>
        </div>
